-- =====================================================
-- Elimina las tablas si existían, respetando relaciones
-- =====================================================
...
CREATE TABLE "public"."countrylanguage" (
    ...
    "percentage" float4 NOT NULL CHECK (
        (percentage >= (0)::double precision) AND
...
-- =====================================================
-- Tabla continent (caso de uso: volcado de datos)
-- =====================================================
